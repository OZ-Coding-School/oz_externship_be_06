...
class QuestionListAPITest(TestCase):
    ...
    def test_filter_by_invalid_category_returns_404(self) -> None:
        ...
        self.assertEqual(response.json()["detail"], QuestionNotFoundException.default_detail)
    ...
    def test_invalid_sort_choice_returns_400(self) -> None:
        ...
        # Mixin에 의해 detail에 에러 정보가 담겨있는지 확인
        error_response = response.json()
        error_msg = str(error_response.get("detail", error_response))
        self.assertIn("popular", error_msg)
