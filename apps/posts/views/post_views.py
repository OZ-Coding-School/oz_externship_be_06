...
@extend_schema_view(
    ...
    create=extend_schema(
        ...
        responses={
            ...
            400: inline_serializer(name="PostErrorResponse", fields={"error_detail": DictField()}),
        },
    ),
    update=extend_schema(
        ...
        responses={
            ...
            400: inline_serializer(name="PostUpdateErrorResponse", fields={"error_detail": DictField()}),
        },
    ),
...
class PostViewSet(viewsets.ModelViewSet[Post]):
    ...
    def create(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        if instance is None:
            return Response({"error_detail": "객체 생성에 실패했습니다."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
