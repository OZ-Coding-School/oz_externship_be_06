...
from rest_framework.serializers import BaseSerializer, CharField, IntegerField, JSONField
...
class PostViewSet(viewsets.ModelViewSet[Post]):
    ...
    def create(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        return Response({"detail": "게시글이 성공적으로 등록되었습니다.", "pk": instance.id}, status=status.HTTP_201_CREATED)
