...
class PostCommentAPITestCase(APITestCase):
    ...
    def test_comment_create_success(self) -> None:
        url = reverse("posts:post-comment-list-create", args=[self.post.id])
    ...
    def test_comment_create_required_field(self) -> None:
    ...
    def test_comment_create_unauthorized(self) -> None:
    ...
    def test_comment_list_pagination_and_structure(self) -> None:
    ...
    def test_comment_list_404(self) -> None:
        url = reverse("posts:post-comment-list-create", args=[999999])
